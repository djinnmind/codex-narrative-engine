...
| Language | Dropdown | English | Language for AI-generated prose, descriptions, and dialogue. When set to a non-English language, the AI writes all narrative content in that language while keeping YAML frontmatter keys, type values, and wiki-link syntax in English. |
